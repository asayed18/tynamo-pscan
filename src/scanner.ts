...
import { Logger, ConsoleColors } from '_@/log';
import { ScanOptions, ScannerConstructor } from '_@/types';
...
export default class Scanner {
    ...
    logStats() {
        console.log(
            ...
            Logger.colorMessage(` Total Segments: ${this.totalSegments} | Batch Size: ${this.batchSize} | Current Batch: ${this.batchIdx} | Total Records: ${this.totalRecords} | Progress: ${((this.batchIdx / this.totalSegments) * 100).toFixed(2)}%`, ConsoleColors.BgRed)
        )
    }
}
